...
import com.example.pencil.xiaobao.customtabs.CustomTabsHelper;
...
public class DetailsFragment extends Fragment implements DetailsContract.View {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    mType = (ContentType) getActivity().getIntent()
        .getSerializableExtra(DetailsActivity.KEY_ARTICLE_TYPE);
    mTitle = getActivity().getIntent().getStringExtra(DetailsActivity.KEY_ARTICLE_TITLE);
    mIsNightMode = PreferenceManager.getDefaultSharedPreferences(getContext()).getBoolean(
        InfoConstants.KEY_NIGHT_MODE, false);
    mIsFavorite = getActivity().getIntent()
        .getBooleanExtra(DetailsActivity.KEY_ARTICLE_IS_FAVORITE, false);
  }
  ...
  public void showZhihuDailyContent(@NonNull ZhihuDailyContent content) {
    ...
    if (content.getBody() != null) {
      ...
      mWebView
          .loadDataWithBaseURL("x-data://base", content.getShareUrl(), "text/html", "utf-8", null);
    }
  ...
  @Override
  public void showDoubanMomentContent(@NonNull DoubanMomentContent content,
      @Nullable List<DoubanMomentNewsThumbs> list) {
