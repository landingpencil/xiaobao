...
import com.example.pencil.xiaobao.favorites.FavoritesFragment;
import com.example.pencil.xiaobao.favorites.FavoritesPresenter;
import com.example.pencil.xiaobao.service.CacheService;
import com.example.pencil.xiaobao.timeline.TimelineFragment;
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    new FavoritesPresenter(
        ...
        ZhihuDailyNewsRepository
            .getInstance(ZhihuDailyNewsRemoteDataSource.getInstance(), ZhihuDailyNewsLocalDataSource
                .getInstance(MainActivity.this)),
        DoubanMomentNewsRepository.getInstance(DoubanMomentNewsRemoteDataSource.getInstance(), DoubanMomentNewsLocalDataSource
            .getInstance(MainActivity.this)),
        GuokrHandpickNewsRepository.getInstance(GuokrHandpickNewsRemoteDataSource.getInstance(), GuokrHandpickNewsLocalDataSource
            .getInstance(MainActivity.this)));
