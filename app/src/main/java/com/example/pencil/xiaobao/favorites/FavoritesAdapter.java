...
public class FavoritesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        switch (viewType) {
            case ItemWrapper.TYPE_EMPTY:
                viewHolder = new EmptyViewHolder(
                        mLayoutInflater.inflate(R.layout.item_empty, viewGroup, false));
                break;
            case ItemWrapper.TYPE_ZHIHU:
                viewHolder = new ZhihuItemViewHolder(
                        mLayoutInflater.inflate(R.layout.item_universal_layout, viewGroup, false),
                        mListener);
                break;
            case ItemWrapper.TYPE_DOUBAN:
                viewHolder = new DoubanItemHolder(
                        mLayoutInflater.inflate(R.layout.item_universal_layout, viewGroup, false),
                        mListener);
                break;
            case ItemWrapper.TYPE_DOUBAN_NO_IMG:
                viewHolder = new DoubanNoImageHolder(mLayoutInflater
                        .inflate(R.layout.item_universal_without_image, viewGroup, false),
                        mListener);
                break;
            case ItemWrapper.TYPE_GUOKR:
                viewHolder = new GuokrViewHolder(
                        mLayoutInflater.inflate(R.layout.item_universal_layout, viewGroup, false),
                        mListener);
                break;
            ...
            case ItemWrapper.TYPE_GUOKR_CATEGORY:
                viewHolder = new CategoryViewHolder(
                        mLayoutInflater.inflate(R.layout.item_category, viewGroup, false));
                break;
            default:
                break;
        }
    ...
    public class DoubanNoImageHolder extends RecyclerView.ViewHolder implements
